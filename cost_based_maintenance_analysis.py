...
def visualize_cost_analysis(histories: List[AssetMaintenanceHistory],
    ...
    ax1.plot([], [], 'rx', markersize=10, markeredgewidth=2, label=f'Corrective (${stats["Cc"]:,.0f})')
    ax1.plot([], [], 'go', markersize=8, markeredgewidth=2, label=f'Preventive (${stats["Cp"]:,.0f})')

    ax1.set_xlabel('Time', fontsize=13, fontweight='bold')
    ax1.set_ylabel('Health Index', fontsize=13, fontweight='bold')
    ax1.set_title(f'Asset Trajectories with Maintenance Events (n={len(plot_histories)})',
    ...
    ax4.set_xlabel('Total Cost per Asset', fontsize=11, fontweight='bold')
    ax4.set_ylabel('Frequency', fontsize=11, fontweight='bold')
    ax4.set_title('Distribution of Total Costs', fontsize=12, fontweight='bold')
    ...
    ax5.set_xlabel('Number of Maintenances', fontsize=11, fontweight='bold')
    ax5.set_ylabel('Frequency', fontsize=11, fontweight='bold')
    ax5.set_title('Distribution of Maintenance Events', fontsize=12, fontweight='bold')
    ...
    ax6.set_xlabel('Corrective Cost', fontsize=11, fontweight='bold')
    ax6.set_ylabel('Preventive Cost', fontsize=11, fontweight='bold')
    ax6.set_title('Corrective vs Preventive Costs', fontsize=12, fontweight='bold')
    ...
    if all_events:
        ...
        ax7.plot(times, cumulative_costs, linewidth=2.5, color='darkgreen')
        ax7.fill_between(times, 0, cumulative_costs, alpha=0.3, color='green')
        ax7.set_xlabel('Time', fontsize=12, fontweight='bold')
        ax7.set_ylabel('Cumulative Cost ($)', fontsize=12, fontweight='bold')
        ax7.set_title('Fleet Cumulative Cost Over Time', fontsize=13, fontweight='bold')
    ...
    # Overall title
    fig.suptitle(f'Cost-Based Preventive Maintenance Analysis (α={stats["alpha"]}, Cc=${stats["Cc"]:,.0f}, Cp=${stats["Cp"]:,.0f})',
...
def main():
    ...
    try:
        ...
        if choice == '1':
            dist_type = 'frechet'
            shape = float(input("Fréchet shape [3.0]: ") or "3.0")
            scale = float(input("Fréchet scale [0.01]: ") or "0.01")
