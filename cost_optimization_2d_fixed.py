...
def example_2d_optimization():
    ...
    """
    print("\n" + "="*80)
    print("2D COST OPTIMIZATION - INTERACTIVE MODE")
    print("="*80)
    ...
    # Optimization ranges
    print("\n" + "="*80)
    print("STEP 4: OPTIMIZATION RANGES")
    print("="*80)
    
    print("\nEnter ranges for parameter search:")
    print("  • Threshold τ: will test multiple values")
    print("  • Probability α: will test multiple values")
    print("")
    
    use_default = input("Use default ranges? [Y/n]: ").strip().lower()
    ...
    # Run 2D optimization
    print("\n" + "="*80)
    print("STEP 5: RUNNING 2D OPTIMIZATION")
    print("="*80)
